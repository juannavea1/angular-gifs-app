...
export class Convert {
    public static tosearchGiphyResponse(json: string): searchGiphyResponse {
        return cast(JSON.parse(json), r("searchGiphyResponse"));
    }

    public static searchGiphyResponseToJson(value: searchGiphyResponse): string {
        return JSON.stringify(uncast(value, r("searchGiphyResponse")), null, 2);
    }
}
...
const typeMap: any = {
    "searchGiphyResponse": o([
        { json: "data", js: "data", typ: a(r("Gifs")) },
