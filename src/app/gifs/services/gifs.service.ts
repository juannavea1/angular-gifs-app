...
import { Gifs, searchGiphyResponse } from '../interfaces/giphy.interface';
...
export class GifsService {
  ...
  buscarGifs(valor:string){
    ...
    this.http.get<searchGiphyResponse>(`${this.apiUrl}/search?api_key=${this.apiKey}&q=${valor}&limit=${this.limite}`).subscribe((response:any) =>{
